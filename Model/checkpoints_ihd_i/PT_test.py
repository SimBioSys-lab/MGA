...
def parse_args():
    ...
    # Data
    p.add_argument("--sequence_file", default="ihd_test_esmsequences_1600.npz")
    p.add_argument("--data_file", default="ihd_test_esminterfaces_1600.npz")
    p.add_argument("--edge_file", default="ihd_test_esmedges_1600.npz")
